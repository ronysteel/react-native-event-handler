...
const ArrowIcon = () => (
  <View style={styles.arrowIcon}>
    <Svg width='9' height='15' viewBox='0 0 9 15'>
      <Path
        d='M7.985 13.85L1.62 7.484 7.986 1.12'
        strokeWidth='1.5'
        stroke='#000'
        fill='none'
        fillRule='evenodd'
...
const EpisodeListIcon = () => (
  <View style={styles.episodeListIcon}>
    <Svg width='16' height='13' viewBox='0 0 16 13'>
      <G fill='#000'>
        <Path d='M3.648 4.288l1.41.513-2.932 8.055-1.41-.513zM6.423 0h1.5v12.857h-1.5zM9.994 3.57h1.5v9.287h-1.5zM13.566 1.43h1.5v11.428h-1.5z' />
      </G>
    </Svg>
  </View>
)
